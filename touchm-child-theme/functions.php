 ...
 */
function orbisius_ct_touchm_child_theme_child_theme_enqueue_styles() {
	global $wp_styles;

    $parent_style = 'orbisius_ct_touchm_child_theme_parent_style';
    $parent_base_dir = 'touchm';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_touchm_child_theme_child_theme_enqueue_styles', 25 );

function orbisius_ct_touchm_child_theme_example_function() {
    // put some code here
}