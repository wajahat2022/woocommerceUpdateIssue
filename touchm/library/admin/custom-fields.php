...
array(
	...
	// Portfolio
	"_portfolio_item_size" => array(
		"name" => "_portfolio_item_size",
		"std" => "",
		"title" => "Item Size",
		"description" => "Set this ONLY if you use mixed portfolio. Choose the size of your item from 3 different sizes.",
		"type" => "select",
		"options" => array(
			array( "value" => "three columns", "text" => "1/4 of full width" ),
			array( "value" => "four columns", "text" => "1/3 of full width" ),
			array( "value" => "six columns", "text" => "1/2 of full width" ),
		),
		"location" => "Portfolio"
	),
	...
	"_portfolio_video_m4v" => array(
		"name" => "_portfolio_video_m4v",
		"std" => "",
		"title" => "M4V File Url of Self-hosted video",
		"description" => "Paste the link of uploaded *.M4V video file here.",
		"type" => "text",
		"location" => "Portfolio"
	),
	
	"_portfolio_video_ogv" => array(
		"name" => "_portfolio_video_ogv",
		"std" => "",
		"title" => "Ogv File Url of self-hosted video",
		"description" => "Paste the link of uploaded *.ogv video file here.",
		"type" => "text",
		"location" => "Portfolio"
	),
	
	"_portfolio_audio_m4a" => array(
		"name" => "_portfolio_audio_m4a",
		"std" => "",
		"title" => "M4a File Url of self-hosted audio",
		"description" => "Paste the link of uploaded *.m4a audio file here.",
		"type" => "text",
		"location" => "Portfolio"
	),
	
	"_portfolio_audio_oga" => array(
		"name" => "_portfolio_audio_oga",
		"std" => "",
		"title" => "Oga File Url of self-hosted audio",
		"description" => "Paste the link of uploaded *.oga audio file here.",
		"type" => "text",
		"location" => "Portfolio"
	),
	...
	"_poster_image" => array(
		"name" => "_poster_image",
		"std" => "",
		"title" => "Video or audio preview image",
		"description" => "Paste the link of uploaded *.png/jpg file here. Applies to both Audio and video files",
		"type" => "text",
		"location" => "Portfolio"
	),
	...
	"_slider_link" => array(
		...
		"description" => "Set the destination link of the slider item when a user clicks it, leave blank if you don't want to link anywhere.<br />Example: http://www.google.com/<br />",
		"type" => "text",
		"location" => "Slider"
	),	
	...
	"_slider_video" => array(
		...
		"std" => "",
		"title" => "Vimeo video",
		"description" => "Specify a vimeo video ID. E.g. 15044121. Works with video-supporting sliders only.",
		"type" => "text",
		"location" => "Slider"
	),	
...
function new_meta_boxes( $type ) {
    ...
    echo '<input type="hidden" name="TouchM_meta_box_nonce" value="', wp_create_nonce(basename(__FILE__)), '" />';
...
function create_meta_box() {
	...
	if ( function_exists('add_meta_box') ) {
		add_meta_box( 'new_meta_boxes_page', 'TouchM'  . ' Page Settings', 'new_meta_boxes_page', 'page', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_slider', 'TouchM'  . ' Slider Settings', 'new_meta_boxes_slider', 'slider', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_post', 'TouchM'  . ' Post Settings', 'new_meta_boxes_post', 'post', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_portfolio', 'TouchM'  . ' Portfolio Settings', 'new_meta_boxes_portfolio', 'portfolio', 'normal', 'high' );
	}
}

function save_postdata( $post_id ) {
	
	if ( !wp_verify_nonce(isset($_POST['TouchM_meta_box_nonce']) ? $_POST['TouchM_meta_box_nonce'] : '', basename(__FILE__)) ) {
