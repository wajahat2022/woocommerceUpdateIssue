...
function sidebars(){
	...
	<div class="wrap al_wrap" style="padding:10px">
			...
			<div class="al_opts">	
				...
				<div class="add_sidebar">
					<form method="POST" action="" id="sidebar-form" onsubmit="add_sidebar_link(); return false;">
						...
						<a href="javascript:void(0);" class="al-button medium" onclick="return add_sidebar_link()" title="Add a sidebar">Create</a>
					</form>
				</div>
				<br />
				<table class="list-table" id="sbg_table" >
					...
					<tr class="<?php echo $alt?>">
						...
						<td style="text-align:center"><a href="javascript:void(0);" class="al-button red-back medium" onclick="return remove_sidebar_link('<?php echo $sidebar; ?>',<?php echo $cnt+1; ?>);" title="Delete">Delete</a></td>
					</tr>
					<?php
							$cnt++;
						}
