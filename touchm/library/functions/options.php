...
$options = array(
	...
	array(
		...
		'type' => 'select',
		'std' => '',
		'desc' => 'Choose one of 4 types of sliders to display on homepage.',
		'options' => array(
			array( "value" => "revolution", "text" => "Revolution (Any content)"),
			array( "value" => "flex", "text" => "Flex (Video support)"),
			array( "value" => "camera", "text" => "Camera (Video support)"),
			array( "value" => "mirror", "text" => "Mirror (Images only)"),
		)
	),	
	...
	array(
		...
		array(
			...
			'id' => $shortname.'_revolution_interval',
			'type' => 'text',
		...
		array(
			'name' => 'Layout type',
			'id' => $shortname.'_revolution_fullwidth',
			'type' => 'select',
			'desc' => 'Choose between boxed and full width layouts.',
			'options' => array(
				array( "value" => "off", "text" => "Boxed" ),
				array( "value" => "on", "text" => "Full width"),
			),
		),	
		...
		array(
			'name' => 'Stop loop at the last Slide',
			'id' => $shortname.'_revolution_stoploop',
			'type' => 'select',
			'desc' => 'Whether to stop slides loop at the last slide or have it in a loop.',
			'options' => array(
	...
	/**************** Mirror Slider Options ****************/
	
	array(
		'type' => 'toggle',
		'item_name' => 'Mirror Slider',
		'toggle_id' => 'mirror-slider'
	) ,
	...
	array( 
		"name" => "Layout type",
		"desc" => "Choose between 3 available layout types.",
		"id" => $shortname."_blog_layout",
		"type" => "select",
		'options' => array(
			array( "value" => "3", "text" => "Default"),
			array( "value" => "2", "text" => "Alternative 1"),
			array( "value" => "1", "text" => "Alternative 2"),
		)
	),
	...
	array( 
		...
		"desc" => "Author biography on blog's inner page.",
