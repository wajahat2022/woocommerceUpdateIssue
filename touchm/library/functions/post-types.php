...
function slider_order_page() 
{
	...
	<div class="wrap">
        <h2>Sort Slides</h2>
        Simply drag the slides up or down and they will be saved in that order.
        ...
        <table id="sortable-table" class="wp-list-table widefat fixed posts">
            ...
            <tbody data-post-type="slider"><!--?php while( $products--->
				<?php if( $slides->have_posts() )  : ?>
                    ...
                    <?php endwhile; ?>
                <?php else : ?>        
                    No products slides found, make sure you <a href="post-new.php?post_type=product">create one</a>.
                <?php endif; ?>
...
function portfolio_register() {	
	...
	register_taxonomy( 'portfolio_category', 
						...
						array( 'hierarchical' => true, 
								'label' => __('Categories', 'TouchM'),
								'singular_label' => __('Category', 'TouchM'), 
								'public' => true,
  								'show_tagcloud' => false,
								'query_var' => 'true',
